...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definition of a linear equation}, bottomtitle=1mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definition of a system of linear equations}, bottomtitle=1mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definition of a solution}, bottomtitle=1mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, opacityback=0, toptitle=1mm, bottomrule=.15mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6]
...
\addcontentsline{toc}{chapter}{Row Reduction and Echelon Forms}

\markboth{Row Reduction and Echelon Forms}{Row Reduction and Echelon
Forms}
...
\addcontentsline{toc}{section}{Solving Systems of Linear Equations}

\markright{Solving Systems of Linear Equations}
